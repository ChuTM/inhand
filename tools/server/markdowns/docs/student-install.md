...
During the install you will be asked to grant **Screen Recording** permission. This is required so the teacher can view your screen.
...
- **Manually** — re-run the install script; it replaces the app while preserving your configuration:
